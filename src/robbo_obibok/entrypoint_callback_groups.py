...
@dataclass(slots=True)
class PlaybackEntrypointCallbacks(PlaybackStaticCallbacks):
...
LibraryEntrypointCallbacks = LibraryStaticCallbacks
...
@dataclass(slots=True)
class CollectionEntrypointCallbacks(CollectionStaticCallbacks):
...
@dataclass(slots=True)
class BootstrapEntrypointCallbacks(BootstrapStaticCallbacks):
