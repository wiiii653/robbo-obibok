...
from robbo_obibok import robbo_obibok_logged_launcher as logged_launcher
...
class RunBotLoggedTests(unittest.TestCase):
    def test_build_logged_launch_command_uses_runtime_env_and_strict_selection(self):
        ...
        with patch("robbo_obibok.robbo_obibok_logged_launcher.load_runtime_environment", return_value=env):
    ...
    def test_run_logged_bot_launches_process_and_returns_exit_code(self):
        ...
        with (
            patch(
                "robbo_obibok.robbo_obibok_logged_launcher.build_logged_launch_command",
                return_value=(
            ...
            patch(
                "robbo_obibok.robbo_obibok_logged_launcher.subprocess.Popen",
    ...
    def test_run_logged_bot_terminates_on_keyboard_interrupt(self):
        ...
        with (
            ...
            patch("robbo_obibok.robbo_obibok_logged_launcher.subprocess.Popen", return_value=proc),
            patch("sys.stdout.flush", lambda: None),
        ):
            exit_code = logged_launcher.run_logged_bot(root=Path("/tmp/robbo"))
